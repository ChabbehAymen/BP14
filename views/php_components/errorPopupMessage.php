...
function showPopUpMessage(int $type = null): void{
    $svg='<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-8 w-8 text-white">
 <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>';
    if ($type == 1){

    }
echo '<div class="absolute w-min items-center justify-center bg-gray-100 purchasing-successful" style="top: 30%; left: 40%">
