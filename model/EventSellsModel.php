...
class EventSellsModel extends HomePageModel
{
    ...
    {
        $q = "SELECT UTILISATEUR.NOM, UTILISATEUR.PRENOM, UTILISATEUR.EMAIL, NUM_FACTURE  AS NF, TITRE ,FACTURE.DATE_ACHAT,EVENEMENT.TARIF_NORMAL, EVENEMENT.TARIF_REDUIT,
...
IFNULL((SELECT ifnull(COUN_NORMAL,0)*EVENEMENT.TARIF_NORMAL), 0) AS 'TOTAL_NORMAL',
...
IFNULL((SELECT ifnull(COUN_REDUIT,0)*EVENEMENT.TARIF_REDUIT), 0) AS 'TOTAL_REDUIT',
(SELECT ifnull(COUN_NORMAL,0)+ifnull(COUN_REDUIT,0)) AS TOTAL_BILLET,
